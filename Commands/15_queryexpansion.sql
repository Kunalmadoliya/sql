...
CREATE TABLE queryexpansion_example (
    id INT PRIMARY KEY,
    content TEXT
);

INSERT INTO queryexpansion_example (id, content) VALUES
...
create fulltext index queryexpansion_index on queryexpansion_example(content)

explain
select * from queryexpansion_example
where match content against ("understanding" with query expansion)
